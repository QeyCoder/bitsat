...
import java.util.*;
    ...
    /*
    This Java roundzero.code is given for your convenience. Feel free to modify as required.
    */
...
public class LiftStopCount {
    public static long solveProblem() {
            ...
            Write solution roundzero.code here

            */
        return 0;
    }

    //Sample roundzero.code only. Feel free to change to accept the input described in the problem.
